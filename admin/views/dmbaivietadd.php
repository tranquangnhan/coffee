            ...
            <div class="col-lg-12 bg-white pb-4 border">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <h3 class="mt-4 text-center">THÊM DANH MỤC BÀI VIẾT</h3>
                            <p class="text-center">Bạn có thể thêm danh mục bài viết ở đây!</p>
                            <div class="row">
                                <div class="col-lg-3">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-3">
                                    <label for=""><strong>Loại</strong></label>
                                </div>
                                <div class="col-lg-9">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-check">
                                                ...
                                                <input type="radio" class="form-check-input" name="loai" id="" value="0" checked>
                                                Coffee
                                            </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="loai" id="" value="1" checked>
                                                Máy Coffee
                                            </label>
                                            </div>
                                        </div>
