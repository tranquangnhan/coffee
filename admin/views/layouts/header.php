                    ...
                    <ul class="yoo-nav-list">
                        <li>
                            <a href="?ctrl=hanghoa&act=index">
                                ...
                                <ion-icon name="albums" role="img" class="md hydrated" aria-label="albums"></ion-icon>Tất Cả Sản Phẩm
                            </a>
                        </li>
                        <li>
                            <a href="?ctrl=contact&act=index">
                                ...
                                <ion-icon name="cloud" role="img" class="md hydrated" aria-label="cloud"></ion-icon> Đơn Hàng
                            </a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="yoo-toggle-body yoo-profile-nav yoo-style1">
                                <div class="yoo-toggle-btn yoo-profile-nav-btn">
                                    <div class="yoo-profile-nav-text mt-2">
                                        ...
                                        <a href="<?= ADMIN_URL."/controllers/login.php?act=logout&idout=1"; ?>" class="text-warning">Đăng Xuất ?</a>
                                    </div>
                ...
                <div class="col-lg-2.5 nav-left bg-white">
                    ...
                    <div class="nav-main mt-3">
                        <ul>
                            ...
                            <li class="<?php if(isset($_GET['ctrl']) &&$_GET['ctrl']=="dmbaiviet") echo "active";?>">
                                <div class="nav-link">
                                <div class="nav-main__icon"><svg  width="25" xmlns="http://www.w3.org/2000/svg" class="ionicon s-ion-icon" viewBox="0 0 512 512"><path d="M396 432H136c-36.44 0-70.36-12.57-95.51-35.41C14.38 372.88 0 340 0 304c0-36.58 13.39-68.12 38.72-91.22 18.11-16.53 42.22-28.25 69.18-33.87a16 16 0 0011.37-9.15 156.24 156.24 0 0142.05-56C187.76 91.69 220.5 80 256 80a153.57 153.57 0 01107.14 42.9c24.73 23.81 41.5 55.28 49.18 92a16 16 0 0012.12 12.39C470 237.42 512 270.43 512 328c0 33.39-12.24 60.78-35.41 79.23C456.23 423.43 428.37 432 396 432z"></path></svg></div>
                                    <div class="nav-main__text "><div id="bv" class="click_title">DM Bài Viết</div>
                                        <div class="menu-alert">
                                            <ul>
                                            <li><a href="<?= ADMIN_URL."/index.php?ctrl=dmbaiviet&act=add";?>">Thêm</a></li>
                                                <li><a href="<?= ADMIN_URL."/index.php?ctrl=dmbaiviet&act=index";?>">Danh Sách</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="<?php if(isset($_GET['ctrl']) &&$_GET['ctrl']=="baiviet") echo "active";?>">
                                <div class="nav-link">
                                    ...
                                    <div class="nav-main__text "><div id="bv" class="click_title">Bài Viết </div>
                                        <div class="menu-alert">
                                            <ul>
                                                <li><a href="<?= ADMIN_URL."/index.php?ctrl=baiviet&act=add";?>">Thêm Mới</a></li>
                                                <li><a href="<?= ADMIN_URL."/index.php?ctrl=baiviet&act=index";?>">Bài Viết</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="<?php if(isset($_GET['ctrl']) &&$_GET['ctrl']=="loaihang") echo "active";?>">
                                <div class="nav-link">
                                    ...
                                    <div class="nav-main__text "><div id="bv" class="click_title">Danh Mục</div>
                                        <div class="menu-alert">
                                            <ul>
                                                <li><a href="<?= ADMIN_URL."/index.php?ctrl=loaihang&act=add";?>">Thêm Mới</a></li>
                                                <li><a href="<?= ADMIN_URL."/index.php?ctrl=loaihang&act=index";?>">Danh Sách</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="<?php if(isset($_GET['ctrl']) &&$_GET['ctrl']=="hanghoa") echo "active";?>">
                                <div class="nav-link">
                                    ...
                                    <div class="nav-main__text "><div id="bv" class="click_title">Sản Phẩm</div>
                                        <div class="menu-alert">
                                            <ul>
                                                <li><a href="<?= ADMIN_URL."/index.php?ctrl=hanghoa&act=add";?>">Thêm Mới</a></li>
                                                <li><a href="<?= ADMIN_URL."/index.php?ctrl=hanghoa&act=index";?>">Danh Sách</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li >
                                <a href="<?= ADMIN_URL."/index.php?ctrl=contact&act=index";?>" class="nav-link">
                                    ...
                                    <div class="nav-main__text">Đơn Hàng</div>
                                </a>
                            </li>
