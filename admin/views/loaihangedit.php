                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-check">
                                                ...
                                                <input type="radio" class="form-check-input" name="loai" id="" value="0" <?=$coffee?>>
                                                Coffee
                                            </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="loai" id="" value="1" <?=$maycoffee?>>
                                                Máy Coffee
                                            </label>
                                            </div>
                                        </div>
